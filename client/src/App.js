    ...
    return (
        <div className="app">
            <div className="navbar">
                <div className="brand">PowerDevOps</div>
                <div className="nav-links">
                    <a className="home" href="/">Home</a>
                    <a className="youtube" href="https://www.youtube.com">YouTube</a>
                    <a className="courses" href="https://powerdevops.online">Courses</a>
                    <a className="telegram" href="https://t.me">Telegram</a>
                    <a className="instagram" href="https://www.instagram.com">Instagram</a>
                </div>
            </div>
            <h1>PowerDevOps User Management App</h1>
